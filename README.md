...
- **FOG** (Governance Token) 🏛️  
  Has a max supply of **10,000**. Staking FOG in the Pantheon grants governance rights and entitles holders to earn fogSNAKE and fogHOG as rewards.

---

## 📅 Launch Timeline & Key Events

| Event                                       | Date & Time (UTC)        | Duration             |
|---------------------------------------------|--------------------------|----------------------|
| **Genesis Pools (fogSNAKE & fogHOG)**       | March 12, 2025, 12:00 PM | 7 days              |
| **Harvest (FOG Farming Pool) Launch**       | March 13, 2025, 12:00 PM | 2 years (tentative) |
| **Pantheon (FOG Staking & Rewards) Launch** | March 14, 2025, 12:00 PM | Ongoing             |
...
## 🏺 Harvest (FOG Farming Pool)

Starting on **March 13, 2025 (12:00 PM UTC)**, the FOG Farming Pool runs for up to 2 years (tentative). Participants will pay a **25% PSM fee** on rewards. All fees flow into the **Peg Stabilization Reserves (PSR)** to maintain healthy pegs for fogSNAKE and fogHOG.

---

## 🏛️ Pantheon Launch (FOG Staking & Rewards)

The **Pantheon** opens on **March 14, 2025 (12:00 PM UTC)**. By staking **FOG**, users earn **fogSNAKE** and **fogHOG**. Below are new details on claim mechanics and tokenomics.
```mermaid
flowchart LR
    Users -->|"Stake FOG"| Pantheon[Pantheon]
    Pantheon -->|"Claim Rewards (fogSNAKE & fogHOG)"| ClaimOptions{{"Claim Options"}}
...
Instead of fixed burning, **FingerOfGod** now implements an **elastic supply** check 4 times a day (at beginning of each epoch after boostrap phase ends).
...
Staking **FOG** in the Pantheon grants governance rights over protocol parameters (e.g., expansions, fees, or future peg strategies).
```mermaid
pie
...
- **Genesis Pools:** Earn fogSNAKE/fogHOG starting March 12, 2025.
- **FOG Farming Pool:** Begins March 13, 2025.
- **Pantheon:** Launches March 14, 2025, for staking **FOG** and earning dual-token rewards.
